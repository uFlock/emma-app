...
A simple Node.js api-server that implements 2 separate referral award that grant a share when the `POST /claim-free-share` route is hit. All task details and requirements can be found by clicking the purple gummy bear icon above.
